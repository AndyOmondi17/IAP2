                ...
                <form method="post" action="{{ route('books.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <label for="gallery" class="block font-medium text-sm text-gray-700">Gallery</label> 
                            <input type="text" name="gallery" id="gallery" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                    value="{{ old('gallery', '') }}" />        
                            @error('description')
